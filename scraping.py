...
class LinkCrawler(object):
    ...
    def filter_url(self):
        ...
        has_pattern_occurences = any(pattern in self.url for pattern in self.ignore_patterns)
...
class FormParser(object):
    ...
    def parse(self):
        """
            Finds all forms present in the page returned by the GET request and,
            for each field, does the following:
                ...
                try:
                    ...
                    if field_type == 'hidden':
                        ...
                        try:
                            ...
                            fuzz_pattern = fuzz_generator.generate(field_type, max_length, min_length)
